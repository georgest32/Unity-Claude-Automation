...
## Recent Commands
```powershell
1: cd .\UnityProjects\Sound-and-Shoal\
2: .\unity-claude-automation.ps1 -Loop
3: .\unity_claude_automation.ps1 -Loop
4: .\unity_claude_automation.ps1 -Loop -Verbose
5: Unblock-File .\unity_claude_automation.ps1
