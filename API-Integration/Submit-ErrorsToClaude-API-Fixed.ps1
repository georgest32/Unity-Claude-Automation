    ...
    if ($responseText -match '```powershell([\s\S]*?)```') {
        ...
        if ($confirm -eq 'Y' -or $confirm -eq 'y') {
            ...
            try {
                ...
                Write-Host "[OK] Commands executed successfully!" -ForegroundColor Green
            } catch {
                Write-Host "[FAIL] Error executing commands: $_" -ForegroundColor Red
            }
        }
    }
...
Write-Host " API Submission Complete" -ForegroundColor White
Write-Host "========================================" -ForegroundColor Gray
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUasJjXdl/cI+5rfWUefvPFUlC
# PMWgggMwMIIDLDCCAhSgAwIBAgIQdR0W2SKoK5VE8JId4ZxrRTANBgkqhkiG9w0B
...
# CQQxFgQUAqAWzaRK6LwPtDhwHcGrsP62AnswDQYJKoZIhvcNAQEBBQAEggEAQvE/
# 7cSTTwpyfK+8aIdHBiNiN9xDm2XA52DK8S2gmPKk1d65x2zKwqjN9jVlagp4UqQ6
# M7l5adNv4rjt++cpKPLA1tHFpMP7NQF1B+YeqaefjFZmn/aqDY28D/kXvSz7D22V
# 6J0zOC1WfUDYkXEUWSOjqZ3UmLi4+Q9H+rQ9rwOeDLvg+MzbyX4FzmE5hw8Gk/8y
# LEz9MvNSDtN2AxG7e73v7naqAhmbHd3nfnZ/Nge/yT2LRicnCqNDXvuePN79bbf0
# eGuiMv32ADghudZAvLyc1XAbpPW9eve7TceSh7jOCy8zulcl9Xbg1NIQQUdEkE3a
# Jx6smPYQczCWOe2UkQ==
