...
try {
    Import-Module "$moduleBasePath\RecommendationPatternEngine.psm1" -Force -WarningAction SilentlyContinue
    Import-Module "$moduleBasePath\EntityContextEngine.psm1" -Force -WarningAction SilentlyContinue
    Import-Module "$moduleBasePath\ResponseClassificationEngine.psm1" -Force -WarningAction SilentlyContinue
    Import-Module "$moduleBasePath\BayesianConfidenceEngine.psm1" -Force -WarningAction SilentlyContinue
