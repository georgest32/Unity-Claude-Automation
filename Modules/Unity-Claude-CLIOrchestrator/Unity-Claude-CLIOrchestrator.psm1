...
Import-Module (Join-Path $PSScriptRoot "Core\WindowManager.psm1") -Force -Global -WarningAction SilentlyContinue
Import-Module (Join-Path $PSScriptRoot "Core\PromptSubmissionEngine.psm1") -Force -Global -WarningAction SilentlyContinue
Import-Module (Join-Path $PSScriptRoot "Core\AutonomousOperations.psm1") -Force -Global -WarningAction SilentlyContinue
Import-Module (Join-Path $PSScriptRoot "Core\OrchestrationManager.psm1") -Force -Global -WarningAction SilentlyContinue
Import-Module (Join-Path $PSScriptRoot "Core\PermissionHandler.psm1") -Force -Global -WarningAction SilentlyContinue
Import-Module (Join-Path $PSScriptRoot "Core\SafeOperationsHandler.psm1") -Force -Global -WarningAction SilentlyContinue
Import-Module (Join-Path $PSScriptRoot "Core\ClaudePermissionInterceptor.psm1") -Force -Global -WarningAction SilentlyContinue

# Import existing Core components using Import-Module for proper function export
Import-Module (Join-Path $PSScriptRoot "Core\ResponseAnalysisEngine.psm1") -Force -Global -WarningAction SilentlyContinue
Import-Module (Join-Path $PSScriptRoot "Core\PatternRecognitionEngine.psm1") -Force -Global -WarningAction SilentlyContinue
Import-Module (Join-Path $PSScriptRoot "Core\DecisionEngine-Refactored.psm1") -Force -Global -WarningAction SilentlyContinue
Import-Module (Join-Path $PSScriptRoot "Core\ActionExecutionEngine.psm1") -Force -Global -WarningAction SilentlyContinue

# Note: Nested pattern recognition modules (RecommendationPatternEngine, EntityContextEngine, 
# ResponseClassificationEngine, BayesianConfidenceEngine) are imported by PatternRecognitionEngine.psm1
# No need to import them separately here to avoid module nesting limit
