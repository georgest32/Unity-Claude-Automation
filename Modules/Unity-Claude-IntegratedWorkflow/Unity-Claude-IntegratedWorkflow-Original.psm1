...
# Date: 2025-08-21
# REFACTORING STATUS: This module has been refactored into modular components
# Use Unity-Claude-IntegratedWorkflow-Refactored.psm1 for the new architecture

# Log warning about monolithic version
Write-Warning "[Unity-Claude-IntegratedWorkflow] Loading MONOLITHIC VERSION (deprecated) - Consider using refactored version"
Write-Host "[Unity-Claude-IntegratedWorkflow] This is the original 1,714-line monolithic module" -ForegroundColor Yellow
Write-Host "[Unity-Claude-IntegratedWorkflow] For better maintainability, use the refactored version in Unity-Claude-IntegratedWorkflow-Refactored.psm1" -ForegroundColor Yellow
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCGDOyB9800ufTl
# 92nuTYRSF0cucWMahydBi1dCZiCLHqCCAzAwggMsMIICFKADAgECAhB1HRbZIqgr
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIPEvxEdGJiY7ZmA5rn8F6veY
# NDpG0towQAC8LFdlH2jJMA0GCSqGSIb3DQEBAQUABIIBAHrQmZ12I/nJyyrSvWl6
# C5qTqdxAs3SJ5MDugtz5vdKisieB/gh7Kty5HC0I76dfGWiLpq3IaNt0375V2his
# dG9/+VEfBU/sFVT15ELZ/1UAZoTGOLH+DDVtlr9O6AEqdiyelTjmS5mgC4gXTDBo
# swY6WgWpPyeuEmX6Xn5NMd79ufAj3eTgUkRmUjbw2rQFbXOV6RcyTrEDP/+vlj0v
# OgGDgQ/2JCkLQUUZbt1t+977+Xw55N1VqONGs5ZJisL/C+qTgxm05Exy9S/8Lgyp
# arnhs9369DKaFPFfu25LWXCU7a+dW/LEahbngahvNWPddGxycPfrrMnlBovMeME1
# FQc=
