# NOTE: This is the MONOLITHIC version (2,084 lines) - kept for backward compatibility
# Version 2.0.0+ uses the refactored modular architecture in Unity-Claude-UnityParallelization-Refactored.psm1
# See Core/ subdirectory for individual components
# Refactored: 2025-08-25

if ($env:UNITYPARALLEL_DEBUG) {
    Write-Host "[DEBUG] Loading Unity-Claude-UnityParallelization.psm1 (MONOLITHIC VERSION - 2,084 lines)" -ForegroundColor Yellow
    Write-Host "[DEBUG] Consider using the refactored version for better maintainability" -ForegroundColor Yellow
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDMisyXXBm1i/J/
# JFQ+4CrWQj/LQiPU35IvEux1qRwjl6CCAzAwggMsMIICFKADAgECAhB1HRbZIqgr
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEID8QhG8yh6AJQLd1GB0G2ieg
# d2RwKYRpswQJNUfwFXTCMA0GCSqGSIb3DQEBAQUABIIBADu0IwUsZ5/zvqOIvMJO
# Cy+V0GQcONymQ3K3r4MJYcOT8sA1DOFeOvgMo2/wttxNmvUFfFGXv2WJBPPYgpKI
# A88pQnq+ffNHEiAxHhOaIPvUemdZ40l5vSoSQUpE5lXyckU6Cy4PvGiM6IPhuVtx
# dNh9T3yGVZLAgfKp3r1Ggf8UZ39PPDBB+3N/qjqwqFOILGEGgOTACslGs94fF+2d
# 21yCNOKSO7ZVVUD9kMimS+qR8AWWR50j49memJWm0X5fJVpZA+ywNchHX15JPfnD
# BIMP4cKqPgQyFnzgbUGEk4AbAQhw3MNAfNy3xDKANaaElAFLjTunrNr9BuyCEE5+
# ki0=
