# Export-ErrorsForClaude-Fixed.ps1
...
Write-Host ""
Write-Host "Or use -CopyToClipboard to copy automatically" -ForegroundColor Gray
Write-Host "------------------------------------------------" -ForegroundColor DarkGray
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUkmbGsRSZfN47aaWO52OM6RoB
# zLigggMwMIIDLDCCAhSgAwIBAgIQdR0W2SKoK5VE8JId4ZxrRTANBgkqhkiG9w0B
...
# CQQxFgQUaskfXrM7v4IpWP+gatwv5I2aEMMwDQYJKoZIhvcNAQEBBQAEggEAVYQt
# aQvuIYw506wcOnHvURheBxpbVMzUII4mcIIYZkMpfcC6qP+gobAb2oBHMKbnIrTG
# FSeivOM6i9KjTObI9/6bOoH1SyhoVNKInD5K5t4YU2KRT8ySFaeyPmiqq/kGXxgs
# JDkzyhXt1fwTKlw7plA4nv0SpVA3tsWVWQ0xirEMDfs/H1wWSikIfuE9Ep77Dsjr
# N1WiUnUdOeicKR7q96oWA/NdAO/DHAAMPeYT7dP/Iio9up/blU/fzjck3Cmtdu3u
# YPS5ONW/sCkdP5u59Az/QJnehU3eyDmzgoS/dpsfxEQEQ6zJ+uQBWiwyffza24kx
# 3YeJ0AfaKzqbjGAIPw==
